...
public class ComplexNumberTest {
    ...
    RealNumber number1, number2, number3, number4, number5, number6, number7, number8, number9, number10;
    RealNumber sum1, sum2, sum3, sum4, sum5, sum6, sum7, sum8, sum9, sum10;
    ...
    @Before
    public void setup() {
        number1 = new RealNumber(10, 3);
        number2 = new RealNumber(9, 8);
        number3 = new RealNumber(5, -7);
        number4 = new RealNumber(4, -3);
        number5 = new RealNumber(0, 0);
        number6 = new RealNumber(1, -10);
        number7 = new RealNumber(-11, -11);
        number8 = new RealNumber(2, 7.7f);
        number9 = new RealNumber(-8, 5);
        number10 = new RealNumber(0, -5);
    }
