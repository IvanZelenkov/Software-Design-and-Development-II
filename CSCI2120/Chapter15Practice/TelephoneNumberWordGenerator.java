...
public class TelephoneNumberWordGenerator {
    private static final String[] letras = { null, null, "A B C", "D E F", " G H I ", "J K L", "M N O", " P R S", "T U V", "W X Y" };

    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);

        System.out.print("Enter the numbers of phone: ");
        String phoneNumberString = input.nextLine();
        input.close();

        write(separator(phoneNumberString));
    ...
    public static void write(int[] phoneNumber) {
        ...
        try {
            printStream = new PrintStream(Files.newOutputStream(Paths.get("/Users/ivanzelenkov/Desktop/Java_2120/src/Chapter15Practice/combinations.txt")));
