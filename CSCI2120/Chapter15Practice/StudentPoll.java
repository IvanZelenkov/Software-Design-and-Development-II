...
public class StudentPoll {
    ...
    public static void checkFrequency() {
        try {
            inputReader = new Scanner(Paths.get("/Users/ivanzelenkov/Desktop/Java_2120/src/Chapter15Practice/numbers.txt"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void writeFrequency() {
        try {
            outputWriter = new Formatter("/Users/ivanzelenkov/Desktop/Java_2120/src/Chapter15Practice/output.txt");
