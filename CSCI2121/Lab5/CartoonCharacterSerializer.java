...
public class CartoonCharacterSerializer implements Serializable{
	...
	public static void serializeCharacter(CartoonCharacter character) {
		...
		//Close the stream
		try (ObjectOutputStream outputCartoon = new ObjectOutputStream(new FileOutputStream("Cartoon.ser"))) {
	...
	public static CartoonCharacter deserializeCharacter() {
		...
		try (ObjectInputStream inputCartoon = new ObjectInputStream(new FileInputStream("Cartoon.ser"))) {
